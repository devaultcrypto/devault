...
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/bitcoin-abc16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/bitcoin-abc32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/bitcoin-abc64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/bitcoin-abc128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/bitcoin-abc256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/bitcoin-abc256.png %{buildroot}%{_datadir}/pixmaps/bitcoin-abc16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/bitcoin-abc256.png %{buildroot}%{_datadir}/pixmaps/bitcoin-abc32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/bitcoin-abc256.png %{buildroot}%{_datadir}/pixmaps/bitcoin-abc64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/bitcoin-abc256.png %{buildroot}%{_datadir}/pixmaps/bitcoin-abc128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/bitcoin-abc256.png %{buildroot}%{_datadir}/pixmaps/bitcoin-abc256.xpm
