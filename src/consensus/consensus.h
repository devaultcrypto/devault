...
/** Default setting for maximum allowed combined transaction for a block, in bytes
         make slightly less than Max BLOCK size above */
static const uint64_t MAX_COMBINED_TX_SIZE = 30 * ONE_MEGABYTE;
/**
