...
public:
    explicit AmountSpinBox(QWidget *parent)
        : QAbstractSpinBox(parent), currentUnit(BitcoinUnits::DVT),
          singleStep(10*Amount::min_amount()) {
    ...
    Amount value(bool *valid_out = nullptr) const { return parse(text(), valid_out); }
