...
static void GetResults(std::map<Amount, CAccountingEntry> &results) {
    ...
    for (CAccountingEntry &ae : aes) {
        results[ae.nOrderPos * Amount(1)] = ae;
    }
}
...
BOOST_AUTO_TEST_CASE(acc_orderupgrade) {
    ...
    BOOST_CHECK(results[2 * Amount(1)].nTime == 1333333336);
    BOOST_CHECK(results[2 * Amount(1)].strOtherAccount == "c");
    ...
    BOOST_CHECK(1 == vpwtx[0]->nOrderPos);
    BOOST_CHECK(results[2 * Amount(1)].nTime == 1333333336);
    BOOST_CHECK(results[3 * Amount(1)].nTime == 1333333330);
    BOOST_CHECK(results[3 * Amount(1)].strComment.empty());
    ...
    BOOST_CHECK(results[3 * Amount(1)].nTime == 1333333336);
    BOOST_CHECK(results[4 * Amount(1)].nTime == 1333333330);
    BOOST_CHECK(results[4 * Amount(1)].strComment.empty());
    ...
    BOOST_CHECK(results[4 * Amount(1)].nTime == 1333333330);
    BOOST_CHECK(results[4 * Amount(1)].strComment.empty());
    BOOST_CHECK(results[5 * Amount(1)].nTime == 1333333334);
