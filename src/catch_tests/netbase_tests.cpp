...
TEST_CASE("netbase_splithost") {
  ...
  BOOST_CHECK(TestSplitHost("127.0.0.1:33039", "127.0.0.1", 33039));
  BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
  BOOST_CHECK(TestSplitHost("[127.0.0.1]:33039", "127.0.0.1", 33039));
  BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
  BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:33039", "::ffff:127.0.0.1", 33039));
  BOOST_CHECK(TestSplitHost("[::]:33039", "::", 33039));
  BOOST_CHECK(TestSplitHost("::33039", "::33039", -1));
  BOOST_CHECK(TestSplitHost(":33039", "", 33039));
  BOOST_CHECK(TestSplitHost("[]:33039", "", 33039));
...
TEST_CASE("netbase_lookupnumeric") {
  ...
  BOOST_CHECK(TestParse("127.0.0.1:33039", "127.0.0.1:33039"));
  BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
  BOOST_CHECK(TestParse("::", "[::]:65535"));
  BOOST_CHECK(TestParse("[::]:33039", "[::]:33039"));
  BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
...
TEST_CASE("netbase_getgroup") {
  ...
  Vec8 internal_group = {NET_INTERNAL, 0x12, 0x92, 0x94, 0x00, 0xeb, 0x46, 0x07, 0xc4, 0xac, 0x07};
