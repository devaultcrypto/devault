...
BOOST_AUTO_TEST_CASE(sanity) {
  ...
  uint256 p11111 = uint256S("0000000069e244f73d78e8fd29ba2fd2ed618bd6fa2ee92559f542fdb26e7c1d");
...
TEST_CASE("ban_fork_prior_to_and_at_checkpoints") {
  ...
  BOOST_CHECK(headerG.GetHash() == uint256S("000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f"
                                            "1b60a8ce26f"));
  BOOST_CHECK(ProcessNewBlockHeaders(config, {headerG}, state, &pindex, &invalid));
  pindex = nullptr;

  CBlockHeader headerA, headerB, headerAA, headerAB;
  CDataStream stream = CDataStream(ParseHex("010000006fe28c0ab6f1b372c1a6a246ae63f74f931e8365e15a089c68d6190000"
  ...
  stream >> headerA;
  BOOST_CHECK(headerA.GetHash() == uint256S("00000000839a8e6886ab5951d76f411475428afc90947ee320161"
                                            "bbf18eb6048"));
  BOOST_CHECK(headerA.hashPrevBlock == headerG.GetHash());

  stream = CDataStream(ParseHex("010000004860eb18bf1b1620e37e9490fc8a427514416fd75159ab86688e9a8300"
                       ...
                       SER_NETWORK, PROTOCOL_VERSION);
  stream >> headerAA;
  BOOST_CHECK(headerAA.GetHash() == uint256S("000000006a625f06636b8bb6ac7b960a8d03705d1ace08b1a19da"
                                             "3fdcc99ddbd"));
  BOOST_CHECK(headerAA.hashPrevBlock == headerA.GetHash());

  stream = CDataStream(ParseHex("000000206fe28c0ab6f1b372c1a6a246ae63f74f931e8365e15a089c68d6190000"
  ...
  stream = CDataStream(ParseHex("000000204860eb18bf1b1620e37e9490fc8a427514416fd75159ab86688e9a8300"
