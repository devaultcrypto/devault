...
TEST_CASE("testpushopcode_tests") {
...
void TestFormatRoundTrip(const std::string &script) { BOOST_CHECK_EQUAL(script, FormatScript(ParseScript(script))); }

TEST_CASE("format_script_test") {
