...
define $(package)_build_cmds
	CC="$($(package)_cc)" CXX="$($(package)_cxx)" cmake . -DCMAKE_SYSTEM_NAME=$(sys_os) -DWITH_TESTS=0 -DWITH_GFLAGS=1 -DPORTABLE=1 -DWITH_RUNTIME_DEBUG=0 -DWITH_TOOLS=0 -DWITH_LZ4=0 -DWITH_ZLIB=0 -DWITH_ZSTD=0
endef
